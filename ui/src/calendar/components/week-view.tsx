...
export function WeekView({ date, events, selectionSlot, onEventClick, onEventContextMenu, onToggleComplete, onSlotClick, onEventDrop, onEventResize, onEmptyAllDayContextMenu, onEmptyGridContextMenu }: WeekViewProps) {
  const days = getWeekDays(date);
  return (
    <TimeGrid
      days={days} events={events} selectionSlot={selectionSlot}
